...
prompt5 .STR " are: <INSERT LIST OF PRIMES, ONE PER LINE>"
...
;functon mod(r0, r1), returns mod value
...
MAIN            CALL BEGINPRT   ;user int is inside R0
                ALCI R12, #80   ;r12 is the base pointer into the heap, basically acting like an array 
